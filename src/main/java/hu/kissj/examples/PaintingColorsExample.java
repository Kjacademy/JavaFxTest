...
public class PaintingColorsExample implements ExampleBuilder {

    @Override
    public void build(final Stage primaryStage) {
        primaryStage.setTitle("Chapter 2 Painting Colors");
        final Group root = new Group();
        final Scene scene = new Scene(root, 350, 300, Color.WHITE);
...
// A rectangle filled with a linear gradient with a translucent color.
        ...
        LinearGradient linearGrad = new LinearGradient(
                0, // start X
                0, // start Y
                0, // end X50 CHAPTER 2: JavaFX Fundamentals
                1, // end Y
                true, // proportional
